...
Always run `build_runner` first when Drift/Freezed files have changed — generated `*.g.dart` and `*.freezed.dart` files must be up-to-date before analysis or tests.
