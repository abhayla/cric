...
tools: Read, Write, Edit, Glob, Bash, WebSearch
...
2. Search `docs/planning/adr/ADR-COMMON-*`, create if not found
...
- **ADR**: `docs/planning/adr/ADR-[4-digit number]-[title].md` (e.g., ADR-0001)
- **Design Doc**: `docs/planning/design/[feature-name]-design.md`
