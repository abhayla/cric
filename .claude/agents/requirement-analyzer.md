...
**Field descriptions**:
- `affectedLayers`: Layers determined from affectedFiles paths (e.g., `apps/server/` → "server", `apps/mobile/` → "mobile"). Used by fullstack orchestrator for per-layer Design Doc creation
