...
class ResponsiveLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Android phone layout — adapt for orientation
...
```dart
// First page — use go_router for navigation
GestureDetector(
  onTap: () {
...
### List with Pull-to-Refresh (Riverpod + ConsumerWidget)

```dart
// Use ConsumerWidget with Riverpod for state management
...
- Platform-specific native code → Use `flutter-android-integration`
